  ...
  render() {
    return (
      <div className="weather-list-item">
        ...
        <p className="high-temp">High: {this.props.forecastItem.high}°F</p>
        <p className="low-temp">Low: {this.props.forecastItem.low}°F</p>
        <p className="description">{this.props.forecastItem.text}</p>
        <img className="icon" src={this.props.forecastItem.image} />
      </div>
    );
  }
}